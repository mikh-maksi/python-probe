...
q = {'question': "Какой язык самый популярный:", 'answer1': "JavaScript",
     'answer2': "Python", 'answer3': "Java", 'answer4': "C#", 'right': 1}
dicts.append(q)
q = {'question': "Какая доля Python:", 'answer1': "12%",
     'answer2': "13,2%", 'answer3': "15%", 'answer4': "50%", 'right': 2}
dicts.append(q)
q = {'question': "Сколько в среденем зарабатывает Python-разработчик:", 'answer1': "$1500",
     'answer2': "$2000", 'answer3': "$2500", 'answer4': "$2500", 'right': 3}
dicts.append(q)
nQuestion = 0
allQuestion = 3
result = 0
...
exit_quiz_text = c.create_text(680, 180,
                               font='Arial 30',
                               fill='orange',
                               text="Закончить :)",
                               state='hidden'
...
answer_text1 = c.create_text(200, 250, font='Arial 30', fill='black', text=dicts[nQuestion].get(
    'answer1'), state='normal', activefill='bisque', justify="center")
answer_text2 = c.create_text(600, 250, font='Arial 30', fill='black', text=dicts[nQuestion].get(
    'answer2'), state='normal', activefill='bisque', justify="left")
answer_text3 = c.create_text(200, 350, font='Arial 30', fill='black', text=dicts[nQuestion].get(
    'answer3'), state='normal', activefill='bisque')
answer_text4 = c.create_text(600, 350, font='Arial 30', fill='black', text=dicts[nQuestion].get(
    'answer4'), state='normal', activefill='bisque')
...
def nextQuestion(event):
    ...
    if nQuestion == allQuestion:
        result_answer = c.create_text(400, 150,
                                      font='Arial 20',
                                      fill='red',
                                      text='Итоговый результат: {}'.format(
                                          result) + ' из {}'.format(allQuestion),
                                      state='normal'
                                      )
        c.itemconfigure(next_question, state='hidden')
        c.itemconfigure(exit_quiz_text, state='normal')
...
c.tag_bind(exit_quiz_text, "<Button-1>", exitQuiz)
